## Prophet script for predictions of CP's considering eletrical vehicles and amenities
library(prophet)
...
for (postal_code in postal_codes) {
  ...
  amenities <- colnames(df_postcode)[5:ncol(df_postcode)]
...
write.csv(final_df_prophet_cp, file = "datasets/prediction_cp_prophet_am.csv")
